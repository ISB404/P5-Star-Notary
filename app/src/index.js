...
const lookUpStar = async () => {
  const instance = await StarNotary.deployed();
  const starId = document.getElementById("starId2").value;
  let StarName = await instance.lookUptokenIdToStarInfo(starId, {from: account});
  App.setStatus2("Star name is " + StarName + ".");
}
//
